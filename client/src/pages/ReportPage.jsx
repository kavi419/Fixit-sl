...
function ReportPage() {
    ...
    return (
        <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4 pt-24">
            <div className="w-full max-w-lg bg-slate-900/50 backdrop-blur-md rounded-3xl p-8 shadow-2xl border border-slate-700">
                ...
                ${preview ? 'border-amber-400/50' : 'border-slate-600 hover:border-blue-500 hover:bg-slate-800/50'}`}
                        >
                            {preview ? (
                    ...
                    <input
                        ...
                        required
                        className="w-full bg-slate-800/50 text-slate-100 placeholder-slate-400 px-5 py-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all border border-slate-700 focus:border-blue-500/50"
                    />
                    ...
                    <select
                        ...
                        onChange={handleInputChange}
                        className="w-full bg-slate-800/50 text-slate-100 px-5 py-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all appearance-none cursor-pointer border border-slate-700 focus:border-blue-500/50"
                    >
                    ...
                    <textarea
                        ...
                        required
                        rows="3"
                        className="w-full bg-slate-800/50 text-slate-100 placeholder-slate-400 px-5 py-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all border border-slate-700 focus:border-blue-500/50 resize-none"
                    ></textarea>
              ...
              ${formData.latitude
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 text-white font-bold py-4 rounded-full transition-all duration-300 shadow-lg shadow-blue-900/30 flex items-center justify-center transform hover:scale-[1.02]"
                    >
